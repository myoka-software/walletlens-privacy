...
**Data Storage:** All data you enter (transactions, wallets, receipts) is stored exclusively locally on your device using secure Apple mechanisms. Neither the developer nor third parties have access to your financial history.
...
**Datenspeicherung:** Alle von Ihnen eingegebenen Daten (Transaktionen, Geldbörsen, Belege) werden ausschließlich lokal auf Ihrem Gerät unter Verwendung sicherer Apple-Mechanismen gespeichert. Weder der Entwickler noch Dritte haben Zugriff auf Ihre Finanzhistorie.
...
**データ保存：** お客様が入力したすべてのデータ（取引、ウォレット、レシート）は、Appleの安全なメカニズムを使用して、デバイスのローカルにのみ保存されます。開発者も第三者も、お客様の財務履歴にアクセスすることはできません。
...
**ポリシーの変更：** 新機能（将来のバージョンのクラウド同期など）が追加された場合、このポリシーは更新され、規制で義務付けられている場合はお客様の同意を求めます。
